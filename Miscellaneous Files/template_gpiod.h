/**
  ...
  * @brief      Header file contains function prototypes for <boardname>
  *         
  @verbatim
...
/**
 *  @breif      Initialize boardname specific data
 *  @param      *devBoard pointer to the board data structure 
 *  @return     None
 */
extern void jetsonNanoSetup (struct boardData *devBoard);
